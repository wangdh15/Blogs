...
[原题链接](https://leetcode-cn.com/problems/find-kth-bit-in-nth-binary-string/)

<img src="有趣的杂题/02.png" alt="image-20200810192515265" style="zoom:50%;" />

#### 解题思路

分治的思想。看处在那一段，然后维护翻转的次数即可。
